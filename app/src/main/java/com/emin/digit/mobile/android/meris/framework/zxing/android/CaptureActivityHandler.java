...
package com.emin.digit.mobile.android.meris.framework.zxing.android;
...
import com.emin.digit.mobile.android.meris.framework.zxing.IBarHandler;
import com.emin.digit.mobile.android.meris.framework.zxing.camera.CameraManager;
import com.emin.digit.mobile.android.meris.framework.zxing.decode.DecodeThread;
import com.emin.digit.mobile.android.meris.framework.zxing.view.ViewfinderResultPointCallback;
...
//	private final CaptureActivity activity;
	 ...
	 * 暂停1秒钟,然后继续开始扫码
	 */
	public void pausePreviewAndDecode(){
		try {
			decodeThread.join(1000L); // 默认暂停1秒钟
		} catch (InterruptedException e) {
			// continue
		}
		restartPreviewAndDecode();
	...
	/**
	 * Added 2017-02-08
	 * 暂停 millis 毫秒,然后继续开始扫码
	 */
	public void pausePreviewAndDecode(long millis) {
		try {
			decodeThread.join(millis); // 暂停 millis 毫秒
		} catch (InterruptedException e) {
			// continue
		}
		restartPreviewAndDecode();
